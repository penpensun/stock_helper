...
public class testParser {
    ...
    public void testParser(){
        ...
        */
        ...
        //The second row contains the "Ergebnis je Aktie (unverw�ssert, nach Steurn)"
        Elements eps1ElementList = trElementList.get(1).getElementsByTag("td");
        
        //Output the "Ergebnis je Aktie (unverw�ssert, nach Steurn)"
        ...
        //The third row contains the "Ergebnis je Aktie (verw�ssert, nach Steurn)"
        Elements eps2ElementList = trElementList.get(2).getElementsByTag("td");
         //Output the "Ergebnis je Aktie (verw�ssert, nach Steurn)"
